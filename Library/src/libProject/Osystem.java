...
public class Osystem {
	...
	void showMemberList(List<Member> list) {	//°Ë»öÇÑ Ã¥ ¸®½ºÆ®¸¦ Ãâ·ÂÇÏ´Â ¸Þ¼­µå
		if(list == null || list.size()==0) System.out.println("Á¶È¸ÇÒ µµ¼­°¡ ¾ø½À´Ï´Ù.");	//¸Å°³º¯¼öÀÎ ¸®½ºÆ®°¡ nullÀÌ°Å³ª ±æÀÌ°¡ 0ÀÏ ¶§
		else {
			System.out.println("¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤");
			System.out.printf("¦¢ %-7s | %-38s | %-8s | %-8s | %-5s ¦¢%n", "È¸¿øID","ÀÌ¸§","»ý³â¿ùÀÏ","ÀüÈ­¹øÈ£","»óÅÂ");
			System.out.println("¦¦¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¥");
			for(Member b:list) {//ÀÎµ¦½º(7), Á¦¸ñ(20), ÀúÀÚ(8), ÃâÆÇ»ç(8), ISBN(5), ÁÖÁ¦(5)
				System.out.println(b);
			}
			System.out.println("¦£¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¡¦¤");
			System.out.printf("¦¢ÃÑ %2d°³ÀÇ °Ë»ö°á°ú°¡ ÀÖ½À´Ï´Ù.              ¦¢%n",list.size());
